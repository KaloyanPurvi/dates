...
public class proben {
    ...
    public static void main(String[] args) {
        ...
        int firstDayOfMonth = findingTheFirstDayOfMonth(firstDay, chosenMonth);
        ...
        // if (firstDay != 1) {// System.out.print("   ");
        // }
        if (chosenMonth == 2) {
            for (int i = 1; i <= 29; i++) {
    ...
    public static int findingTheFirstDayOfMonth(int firstDay, int chosenMonth1) {
        int firstDayOfMonth = firstDay;
        for (int i = 2; i <= chosenMonth1; i++) {
            if (i == 3) {
                firstDayOfMonth += 1;
            } else if (i % 2 == 1) {
                firstDayOfMonth += 2;
